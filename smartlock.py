...
class Pin(dict):
	...
	def __init__(self, id: str, smartlockId: str, authId: str, type: int, name: str, enabled: bool, remoteAllowed: bool, lockCount: int, lastActiveDate: datetime.datetime, creationDate: datetime.datetime, updateDate: datetime.datetime, code: str):
		self.id = id
